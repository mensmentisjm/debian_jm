...
text_welcome=u"Witamy w eksperymencie! Za moment zobaczysz serie obrazków. Po wyświetloym obrazku proszę wybrać jak najszybciej jedną pozycje z listy, która najbardziej pasuje do obrazka. Naciśnij spację by przejść dalej."
