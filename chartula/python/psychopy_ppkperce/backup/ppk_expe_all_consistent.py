...
path_get_image = '/home/jesmasta/work/ppk_perception_experiment/experimental_group/'
path_get_image_control = '/home/jesmasta/work/ppk_perception_experiment/control_group/'
path_get_image_test = '/home/jesmasta/work/ppk_perception_experiment/series_test/'
path_get_csv = '/home/jesmasta/work/ppk_perception_experiment/csv/'
...
text_welcome=u"Witamy w eksperymencie! Za moment zobaczysz serie obrazków. Przed wyświetleniem każdego obrazka pojawi się punkt fiksacji, na którym proszę skup wzrok. Po wyświetlonym obrazku proszę wybierz jak najszybciej jedną pozycje z listy, która najbardziej pasuje do obrazka. Naciśnij spację by przejść dalej."
...
for i in range(trials):
    if len(onlyfiles) > 0:
        ...
        if ('delete' in key_pressed): break
...
with open (path_save_csv + pliczek,'wb') as f:
    ...
    zapis.writerow([expo_time, ile_preperation])
